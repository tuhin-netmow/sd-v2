...
const RightSidebar = (props: any) => {
  ...
  useEffect(() => {
    if (
      ...
      (document as any).getElementById("sidebar-color-dark").checked = false;
      (document as any).getElementById("sidebar-color-light").checked = false;
    }
  });
  ...
  useEffect(() => {
    const preloader = (document as any).getElementById("preloader");
    if (preloader) {
      (document as any).getElementById("preloader").style.opacity = "1";
      (document as any).getElementById("preloader").style.visibility =
        "visible";
      setTimeout(function () {
        (document as any).getElementById("preloader").style.opacity = "0";
        (document as any).getElementById("preloader").style.visibility =
          "hidden";
      }, 1000);
    }
