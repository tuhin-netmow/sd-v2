...
const SearchOption = () => {
  ...
  useEffect(() => {
    var searchOptions = document.getElementById("search-close-options") as any;
    var dropdown = document.getElementById("search-dropdown") as any;
    var searchInput = document.getElementById("search-options") as any;
